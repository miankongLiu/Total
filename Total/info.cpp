    ...
    ui(new Ui::info)
{
    ...
    setWindowTitle("参数设置：");
     ...
     ui->tableWidget->setItem(3,0,new QTableWidgetItem("C1  2次方"));
     ui->tableWidget->setItem(4,0,new QTableWidgetItem("C2  4次方"));
     ui->tableWidget->setItem(5,0,new QTableWidgetItem("C3  6次方"));
     ui->tableWidget->setItem(6,0,new QTableWidgetItem("C4  8次方"));
     ui->tableWidget->setItem(7,0,new QTableWidgetItem("C5  10次方"));
     ui->tableWidget->setItem(8,0,new QTableWidgetItem("C6  12次方"));
     ui->tableWidget->setItem(9,0,new QTableWidgetItem("C7  14次方"));
     ui->tableWidget->setItem(10,0,new QTableWidgetItem("C8  16次方"));
     ui->tableWidget->setItem(11,0,new QTableWidgetItem("C9  18次方"));
     ui->tableWidget->setItem(12,0,new QTableWidgetItem("C10  20次方"));
     ui->tableWidget->setItem(13,0,new QTableWidgetItem("C11  22次方"));
     ui->tableWidget->setItem(14,0,new QTableWidgetItem("C12  24次方"));
