...
// Date: Fri Dec 06 10:06:32 2019
// Arguments: "-B" "macro_default" "-W" "cpplib:fitFunc" "-T" "link:lib" "-d"
// "E:\Matlab Pro\fitFunc\for_testing" "-v" "E:\Matlab Pro\fitFunc.m" 
//
...
extern LIB_fitFunc_CPP_API void MW_CALL_CONV fitFunc(int nargout, mwArray& xx, mwArray& zz, const mwArray& a, const mwArray& b, const mwArray& c, const mwArray& s);
